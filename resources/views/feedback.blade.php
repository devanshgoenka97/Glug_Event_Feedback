			...
			<div class="Demo-boot">
				<div class="btn-group" data-toggle="buttons" style="width: 100%">
      				<label class="btn btn-primary" style="width: 10%">
        				<input type="radio" name="organized" id="option1" value="0"> 0
      				</label>
      				<label class="btn btn-primary" style="width: 10%">
        				<input type="radio" name="organized" id="option2" value="1"> 1
      				</label>
      				<label class="btn btn-primary" style="width: 10%">
        				<input type="radio" name="organized" id="option3" value="2"> 2
      				</label>
      				<label class="btn btn-primary" style="width: 10%">
        				<input type="radio" name="organized" id="option3" value="3"> 3
      				</label>
      				<label class="btn btn-primary" style="width: 10%">
        				<input type="radio" name="organized" id="option3" value="4"> 4
      				</label>
      				<label class="btn btn-primary" style="width: 10%">
        				<input type="radio" name="organized" id="option3" value="5"> 5
      				</label>
      				<label class="btn btn-primary" style="width: 10%">
        				<input type="radio" name="organized" id="option3" value="6"> 6
      				</label>
      				<label class="btn btn-primary" style="width: 10%">
        				<input type="radio" name="organized" id="option3" value="7"> 7
      				</label>
      				<label class="btn btn-primary" style="width: 10%">
        				<input type="radio" name="organized" id="option3" value="8"> 8
      				</label>
      				<label class="btn btn-primary" style="width: 10%">
        				<input type="radio" name="organized" id="option3" value="9"> 9
      				</label>
